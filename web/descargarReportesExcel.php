...
?>
    <!-- boton para generar excel -->
      <center>
     <button type="button" class="btn btn-outline-success"  onclick="window.location.href = 'excel.php?sent=2';">Descargar Excel</button>
     </center>
  <?php
     break;  
...
//Termina el query y la bandeja - debemos cerrar el body y html para cargar toda la pagina como un PDF
  ?>
       <!-- boton para generar excel -->
      <center>
     <button type="button" class="btn btn-outline-success"  onclick="window.location.href = 'excel.php?sent=4';">Descargar Excel</button>
     </center>
  <?php
      break;  
...
//Termina el query y la bandeja - debemos cerrar el body y html para cargar toda la pagina como un PDF
  ?>
    <!-- boton para generar excel -->
      <center>
     <button type="button" class="btn btn-outline-success"  onclick="window.location.href = 'excel.php?sent=6';">Descargar Excel</button>
     </center>
  <?php
      break;
}
